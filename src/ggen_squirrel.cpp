...
DECLARE_ENUM_TYPE(GeoGen::GGen_Normalization_Mode);
DECLARE_ENUM_TYPE(GeoGen::GGen_Overflow_Mode);
DECLARE_ENUM_TYPE(GeoGen::GGen_Direction);
DECLARE_ENUM_TYPE(GeoGen::GGen_Message_Level);
DECLARE_ENUM_TYPE(GeoGen::GGen_Voronoi_Noise_Mode);
DECLARE_ENUM_TYPE(GeoGen::GGen_Comparison_Mode);
DECLARE_ENUM_TYPE(GeoGen::GGen_Outline_Mode);
...
namespace GeoGen{
	...
	GGen_Squirrel::GGen_Squirrel(){
		...
		/* Constraint getters */
		RegisterGlobal(&Generator::GetMaxMapSize, _SC("GGen_GetMaxMapSize"));	
		RegisterGlobal(&Generator::GetMaxMapCount, _SC("GGen_GetMaxMapCount"));
		...
		try {
...

			{
				...
				if(SQ_SUCCEEDED(sq_get(v,-2))) {
					...
					Generator::GetInstance()->ThrowMessage(GGen_Const_String("\"Generate()\" function was not found in the script!"), GGEN_ERROR, -1);
			...
			Generator::GetInstance()->ThrowMessage(GGen_Const_String("GGen_Data memory allocation failed!"), GGEN_ERROR, -1);
