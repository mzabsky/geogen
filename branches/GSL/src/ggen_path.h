...
/** 
 * @file ggen_path.h Path represents a continuous linear sequence of Point objects.
 **/
...
namespace GeoGen{
	/**
	 * Path represents a continuous linear sequence of Point objects.
	 **/
	class Path{
		public:
			 ...
			 **/
			void AddPointByCoords(CoordOffset x, CoordOffset y);
			 ...
			 * @param point Point to be added.
			 **/
			void InsertPoint(uint32 index, Point& point);
			 ...
			 * @param y Y coordinate of the point to be added.
			 **/
			void InsertPointByCoords(uint32 index, CoordOffset x, CoordOffset y);
			 ...
			 * @param y Y offset.
			 **/
			void Move(CoordOffset x, CoordOffset y);
			 ...
			 **/
			void Transform(CoordOffset origin_x, CoordOffset origin_y, double a11, double a12, double a21, double a22);
			 ...
			 **/
			void Rotate(CoordOffset origin_x, CoordOffset origin_y, int32 angle);
			 ...
			 **/
			void Shear(CoordOffset origin_x, CoordOffset origin_y, int32 horizontal_shear, int32 vertical_shear);
			 ...
			 **/
			void Flip(CoordOffset origin_x, CoordOffset origin_y, Direction direction);
			 ...
			 **/
			void Scale(CoordOffset origin_x, CoordOffset origin_y, double ratio_x, double ratio_y);
	};
}