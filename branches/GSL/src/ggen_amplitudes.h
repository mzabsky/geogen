...
/** 
 * @file ggen_amplitudes.h Amplitudes is an object storing amplitude settings for GGen_Data_1D::Noise and GGen_Data_2D::Noise.
 **/

namespace GeoGen{
	/**
	 * Amplitudes is an object storing amplitude settings for GGen_Data_1D::Noise and GGen_Data_2D::Noise.
	 **/
	class Amplitudes{
		public:
			uint16* data;
